...
def crea_portafoglio():
    ...
    aggiungi_crypto(crypto_portfolio, 'BTC/USDT', '2024-06-25', 100)
    ...
    aggiungi_crypto(crypto_portfolio, 'OP/USDT', '2024-07-04', 20)
    aggiungi_crypto(crypto_portfolio, 'MATIC/USDT', '2024-07-04', 20)
